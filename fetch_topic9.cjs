...
const sheets = [
    ...
    { name: '恆春阿美語', url: 'https://docs.google.com/spreadsheets/d/1KDoK3hT7zFVroVimy_n7GMkPdlcdoHh9TuiaFbtQyWw/export?format=csv' }
];
...
async function main() {
    ...
    fs.writeFileSync('topic9_data.json', JSON.stringify(result, null, 2));
    console.log('Saved topic9_data.json');
}
